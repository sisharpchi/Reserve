...
internal sealed class TenantConfiguration : IEntityTypeConfiguration<Tenant>
{
    public void Configure(EntityTypeBuilder<Tenant> builder)
    {
        ...
        builder.Property(tenant => tenant.CategoryId).HasColumnName("category_id");
        ...
        builder.HasOne<TenantCategory>()
            .WithMany()
            .HasForeignKey(tenant => tenant.CategoryId)
        ...
        builder.HasIndex(tenant => new { tenant.CategoryId, tenant.Status })
