...
public static class TenantsModule
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddScoped<IQueryHandler<GetPlatformTenantCategoriesQuery, PagedResponse<TenantCategoryResponse>>, GetPlatformTenantCategoriesQueryHandler>();
        ...
        services.AddScoped<IQueryHandler<GetPlatformTenantsQuery, PagedResponse<TenantResponse>>, GetPlatformTenantsQueryHandler>();
