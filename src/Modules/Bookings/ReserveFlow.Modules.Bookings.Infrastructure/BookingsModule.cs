...
public static class BookingsModule
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddScoped<IQueryHandler<GetBookingsQuery, PagedResponse<BookingResponse>>, GetBookingsQueryHandler>();
        ...
        services.AddScoped<IQueryHandler<GetModuleMessagesQuery, PagedResponse<ModuleMessageResponse>>, GetModuleMessagesQueryHandler>();
